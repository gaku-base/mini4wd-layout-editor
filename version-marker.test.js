...
test('UI cleanup loader uses the RC6 cache key', () => {
  assert.match(SNAP_SOURCE, /ui-controls-cleanup\.js\?v=v1\.1-rc6-20260821-ui3/);
});

test('presentation racing stylesheet uses the RC6 cache key', () => {
  assert.match(SNAP_SOURCE, /presentation-mode\.css\?v=v1\.1-rc6-20260821-racing2/);
});
