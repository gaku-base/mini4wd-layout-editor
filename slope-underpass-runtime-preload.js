(function preloadSlopeUnderpassRuntime(root) {
  ...
  const CACHE_KEY = 'v1.1-rc6-slope-height1';
  ...
  if (!root.M4WD_SLOPE_UNDERPASS_RUNTIME) {
    const resources = [
  ...
  if (!root.M4WD_SLOPE_HEIGHT_PROPAGATION_RUNTIME) {
    documentRef.write(`<script src="slope-height-propagation-runtime.js?v=${CACHE_KEY}" data-m4wd-slope-height-propagation="1"><\/script>`);
  }
