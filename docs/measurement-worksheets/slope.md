...
割合は採寸位置のラベルであり、実寸ではない。`sMm`は計測できるまで`unknown`とする。

| station ID | 種別 | 計画位置 | sMm | 確認view ID | 追加理由・形状変化 | 状態 |
|---|---|---|---|---|---|---|
| slope-entry | 入口 | 入口 | `unknown` | `unknown` | `unknown` | unknown |
| slope-25 | 中間 | 25% | `unknown` | `unknown` | `unknown` | unknown |
| slope-50 | 中央 | 50% | `unknown` | `unknown` | `unknown` | unknown |
| slope-75 | 中間 | 75% | `unknown` | `unknown` | `unknown` | unknown |
| slope-exit | 出口 | 出口 | `unknown` | `unknown` | `unknown` | unknown |
| `unknown` | 追加station | `unknown` | `unknown` | `unknown` | `unknown` | unknown |

## 6. station別断面集計

次の表を各stationについて複製する。側壁名称はセッション内で内外または左右の対応を定義し、推測で対応付けない。

### station ID：`unknown`

| 項目ID | 測定項目 | 単位 | view ID | calibration ID | 値1 | 値2 | 値3 | 追加値 | 実施回数 | 平均 | 最大差 | 推定誤差 | 信頼度 | 状態 | unknown理由・備考 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| surface-z | 走行面中心高さ | mm | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | none | unknown | `unknown` |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 全長・水平長 | mm | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | none | unknown |
...
| 高低差 | mm | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | none | unknown（公称115mmとの照合欄） |
| 下面エンベロープ | mm | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | none | unknown |
...
| exit | `unknown` | elevationDelta | mm | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | `unknown` | none | unknown（公称115mmとの照合欄） |
