...
test('generate patched app.js artifact for part-shaped guides', () => {
...
`;
  ...
  fs.mkdirSync('artifacts/browser-smoke', { recursive: true });
  fs.writeFileSync('artifacts/browser-smoke/patched-app.js', source, 'utf8');
  fs.writeFileSync('artifacts/browser-smoke/README.txt', 'Temporary artifact used to materialize the exact generated app.js for PR #72.\n', 'utf8');

  throw new Error('intentional artifact handoff: patched-app.js generated successfully');
});
